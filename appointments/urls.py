...
urlpatterns = [
	...
	path('prescription-pdf/<slug:slug>/<int:prescription_id>/', views.prescription_pdf, 
		name='prescription-pdf'),
	path('delete-prescription/<slug:slug>/<int:prescription_id>/', views.delete_prescription, 
	...
	path('doctors/delete-medical-record/<slug:slug>/<int:mr_id>/', views.delete_medical_record, 
	...
	path('patients/', views.patient_dashboard, name='patient-dashboard'),
   	...
   	path('patients/book-appointment/', views.checkoutt, name='checkoutt'),
